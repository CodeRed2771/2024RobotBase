...
public class Crescendo {
    ...
    private static final Pose3d[] Blue_POIs = {
        ...
        new Pose3d(new Translation3d(22.5,233.42,0), new Rotation3d(0,0,120)), // Subwoofer Left
        new Pose3d(new Translation3d(37.5,218.42,0), new Rotation3d(0,0,0)), // Subwoofer Center
        new Pose3d(new Translation3d(22.5,203.42,0), new Rotation3d(0,0,240)), // Subwoofer Right
        new Pose3d(new Translation3d(9,218.42,80), new Rotation3d(0,0,0)), // Speaker
    ...
    private static final Pose3d[] Red_POIs = {
        ...
        new Pose3d(new Translation3d(22.5,89.58,0), new Rotation3d(0,0,300)), // Subwoofer Left
        new Pose3d(new Translation3d(37.5,104.58,0), new Rotation3d(0,0,180)), // Subwoofer Center
        new Pose3d(new Translation3d(22.5,119.58,0), new Rotation3d(0,0,60)), // Subwoofer Right
        new Pose3d(new Translation3d(9,104.58,80), new Rotation3d(0,0,180)), // Speaker
