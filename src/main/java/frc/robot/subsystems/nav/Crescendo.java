...
public class Crescendo {
    ...
    private static final Pose3d[] Blue_POIs = {
        ...
        new Pose3d(new Translation3d(32,264,0), new Rotation3d(0,0,-55)), // Subwoofer AMP
        new Pose3d(new Translation3d(47.5,218.42,0), new Rotation3d(0,0,0)), // Subwoofer Center
        new Pose3d(new Translation3d(32,172,0), new Rotation3d(0,0,55)), // Subwoofer Source
    ...
    private static final Pose3d[] Red_POIs = {
        ...
        new Pose3d(new Translation3d(32,59,0), new Rotation3d(0,0,55)), // Subwoofer AMP
        new Pose3d(new Translation3d(47.5,104.58,0), new Rotation3d(0,0,0)), // Subwoofer Center
        new Pose3d(new Translation3d(32,151,0), new Rotation3d(0,0,-55)), // Subwoofer Source
